...
//arrays of any
const cell: NodeListOf<Element> = document.querySelectorAll('.cell');
...
//     target:any;
// }
const it: HTMLElement = document.querySelectorAll('.cell')[generateRandom];
it.setAttribute('id', 'it');
const clickedBox: HTMLElement[] = [];
